...
def list_accounts():
    ...
    # Use the Account.all() method to fetch all accounts
    accounts = Account.all()

    # Create a list of serialized accounts
    account_list = [account.serialize() for account in accounts]

    # Return the list as JSON with a 200_OK status code
...
def update_accounts(account_id):
    """
    Update an Account
    This endpoint will update an Account based on the data that is posted
    """
    ...
    # 4. Return the updated account as JSON with a 200 OK status
